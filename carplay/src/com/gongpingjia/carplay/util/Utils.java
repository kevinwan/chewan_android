...
public class Utils {
    ...
    public static String formatHtmlData(String html) {
        String templates = "<html><head><meta content=\"initial-scale=1.0,user-scalable=yes,minimum-scale=1.0,maximum-scale=1.0,width=device-width\" name=\"viewport\" /> <style type=\"text/css\">"
    ...
    // * @param mDuration
    // */
    // public static void flySetViewPagerDuration(ViewPager viewPager, int
    // mDuration)
    // {
    // try
    // {
