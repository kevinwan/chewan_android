...
public class PicLayoutUtil {
            ...
            try {
                if (i == headMax - 1) {
                    ...
                    if (i < drawcount - 1) {
                        ...
                        ViewUtil.bindNetImage((RoundImageView) img, JSONUtil.getString(jo, "photo"), "head");
        ...
        img.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                for (int i = 0, len = jsa.length(); i < len; i++) {
                    try {
                        imgUrls[i] = jsa.getJSONObject(i).getString("original_pic");
                    } catch (JSONException e) {
                        e.printStackTrace();
                    }
                }
    ...
    private void addPicOneChild() {
        LinearLayout child = addChild(layout);
        try {
            params = new LayoutParams(DhUtil.dip2px(mContext, 200), DhUtil.dip2px(mContext, 150));
            ImageView img = new ImageView(mContext);
            img.setLayoutParams(params);
            if (type == 1) {
            ...
            img.setOnClickListener(new OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    for (int i = 0, len = imgUrls.length; i < len; i++) {
                        try {
                            imgUrls[i] = data.getJSONObject(i).getString("original_pic");
                        } catch (JSONException e) {
                            e.printStackTrace();
                        }
                    }
