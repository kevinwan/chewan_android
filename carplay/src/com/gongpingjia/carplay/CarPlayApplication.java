...
public class CarPlayApplication extends Application implements Thread.UncaughtExceptionHandler {
    ...
    public void onCreate() {
        ...
        IocContainer.getShare().bind(DaoHelper.class).to(OrmLiteSqliteOpenHelper.class)
                .scope(InstanceScope.SCOPE_SINGLETON);
        IocContainer.getShare().bind(KmlGlobalCodeHandler.class).to(GlobalCodeHandler.class)
                .scope(InstanceScope.SCOPE_SINGLETON);
