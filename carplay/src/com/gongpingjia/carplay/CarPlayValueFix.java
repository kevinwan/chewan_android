...
public class CarPlayValueFix implements ValueFix
{
    ...
    public static DisplayImageOptions optionsDefault, carPicOptions, brandOptions, bigcarOptions;
    static
    {
    ...
    public Object fix(Object o, String type)
    {
        ...
        if ("time".equals(type))
        {
            return getStandardTime(Long.parseLong(o.toString()) * 1000, "yyyy-MM-dd");
        }
