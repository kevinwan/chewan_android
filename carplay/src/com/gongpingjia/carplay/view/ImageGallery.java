    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        pagerAdapter.setOnItemChangeListener(new OnItemChangeListener() {
            ...
            public void onItemChange(int currentPosition) {
                mIndicatorText.setText(getIndicatorString(currentPosition, urls.length));
            }
        });
        Intent it = getIntent();
        ...
        mIndicatorText.setText(getIndicatorString(it.getIntExtra("currentItem", 0) + 1, urls.length));
    }
