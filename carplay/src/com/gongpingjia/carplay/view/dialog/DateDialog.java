    ...
    public void show(final Context context) {
        ...
        builder.setPositiveButton("确  定", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                String dateString = new StringBuilder().append(datePicker.getYear()).append("年")
                        .append(datePicker.getMonth() + 1).append("月").append(datePicker.getDayOfMonth()).append("日")
                        .toString();

                String datef = new StringBuilder().append(datePicker.getYear()).append("-")
                        .append(datePicker.getMonth() + 1).append("-").append(datePicker.getDayOfMonth()).append(" ")
                        .toString();
                ...
                if (onDateResultListener != null) {
                    onDateResultListener.result(dateString, time, datePicker.getYear(), datePicker.getMonth() + 1,
