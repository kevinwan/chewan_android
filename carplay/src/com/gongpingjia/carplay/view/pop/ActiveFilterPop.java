...
public class ActiveFilterPop extends PopupWindow implements OnClickListener {
	...
	public ActiveFilterPop(Activity context) {
		...
		contentV = LayoutInflater.from(context).inflate(
				R.layout.pop_active_filter, null);
		pop = new PopupWindow(contentV, LayoutParams.FILL_PARENT,
	...
	public void initView() {
		...
		// 不可以去掉
		contentV.findViewById(R.id.content_layout).setOnClickListener(
				new OnClickListener() {
		...
		authenticateRG = (RadioGroup) contentV
				.findViewById(R.id.authenticate_rg);
	...
	public interface OnCheckResult {
		void result(String province, String city, String district,
				String gender, String type, Integer authenticate,
				String carLevel);
	}
	...
	private void getSelectResult() {
		...
		if (genderRG.getCheckedRadioButtonId() != -1) {
			RadioButton grb = (RadioButton) genderRG.findViewById(genderRG
		...
		if (authenticateRG.getCheckedRadioButtonId() != -1) {
			RadioButton grb = (RadioButton) authenticateRG
					.findViewById(authenticateRG.getCheckedRadioButtonId());
		...
		if (carLevelRG.getCheckedRadioButtonId() != -1) {
			RadioButton grb = (RadioButton) carLevelRG.findViewById(carLevelRG
					.getCheckedRadioButtonId());
	...
	public void onClick(View v) {
		...
		case R.id.typeLayout:
			...
			CommonDialog dialog = new CommonDialog(context, mTypeOptions,
					"活动类型");
