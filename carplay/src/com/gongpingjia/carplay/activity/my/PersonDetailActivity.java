...
public class PersonDetailActivity extends CarPlayBaseActivity implements
	...
	public void initView() {
		...
		// }
		// });
		topTabV = (LinearLayout) findViewById(R.id.top_tab);
		aboveV = findViewById(R.id.ablove_tab);
		type = RELEASE;
		...
		// aboveV.getLocationOnScreen(location1);
		// int y1 = location1[1];
		//
		// aboveV.setVisibility(y1 >= y ? View.VISIBLE : View.GONE);
		//
		// }
		// });
	...
	private void initAboveTab() {
		for (int i = 0; i < topTabV.getChildCount(); i = i + 2) {
			final int index = i;
			View childV = topTabV.getChildAt(i);
			childV.setOnClickListener(new View.OnClickListener() {
		...
		net.doGetInDialog(new NetTask(self) {
			...
			public void doInUI(Response response, Integer transfer) {
				if (response.isSuccess()) {
					...
					ViewUtil.bindView(aboveV.findViewById(R.id.releaseCount),
							JSONUtil.getString(jo, "postNumber"));
					ViewUtil.bindView(
							aboveV.findViewById(R.id.attention_count),
							JSONUtil.getString(jo, "subscribeNumber"));
					ViewUtil.bindView(aboveV.findViewById(R.id.active_count),
							JSONUtil.getString(jo, "joinNumber"));
	...
	private void setAboveTab(int index) {
		for (int i = 0; i < topTabV.getChildCount(); i = i + 2) {
			LinearLayout childV = (LinearLayout) topTabV.getChildAt(i);
			View img = (View) childV.findViewById(R.id.tabline);
			TextView numText = (TextView) childV.getChildAt(0);
			TextView desText = (TextView) childV.getChildAt(1);
			if (index == i) {
