 ...
 */
public class SettingActivity extends CarPlayBaseActivity implements
		OnClickListener {
	Button setting_btn;

	RelativeLayout setting_clear, setting_like, setting_about_us,
			setting_versions, setting_at_versions;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		mSizeText.setText(String.valueOf(FileUtil.getFileOrDirSize(mCacheFile,
				UNIT_SACLE.M)) + " M");
	}
				...
				public void onSuccess() {
					runOnUiThread(new Runnable() {
						public void run() {
							...
							FilterPreference pre = IocContainer.getShare().get(
									FilterPreference.class);
							pre.load();
							pre.setFirst(null);
							pre.setCarLevel("");
							pre.setCity("");
