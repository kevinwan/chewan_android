...
public class MyFragment extends Fragment implements OnClickListener {
    ...
    LinearLayout carchat, owners_certification, people_concerned, editdata, feedback_layoutV;
    ...
    private void initView() {
        ...
        feedback_layoutV = (LinearLayout) mainV.findViewById(R.id.feedback_layout);
    ...
    private void getMyDetails() {
        ...
        DhNet net = new DhNet(API.CWBaseurl + "/user/" + user.getUserId() + "/info?userId=" + user.getUserId()
                + "&token=" + user.getToken());
        net.doGet(new NetTask(getActivity()) {
            ...
            public void doInUI(Response response, Integer transfer) {
                ...
                if (TextUtils.isEmpty(carModel)) {
                    ...
                    carModelT.setText(carModel + ",  " + drivingExperience + "年车龄");
                }
                ...
                if (TextUtils.isEmpty(carBrandLogo) || carBrandLogo.equals("null")) {
                    ...
                    ViewUtil.bindNetImage(carlogo, carBrandLogo, CarPlayValueFix.optionsDefault.toString());
                }
    ...
    public void onClick(final View v) {
        UserInfoManage.getInstance().checkLogin(getActivity(), new LoginCallBack() {
            ...
            public void onisLogin() {
                ...
                case R.id.head:
                    it = new Intent(getActivity(), EditPersonalInfoActivity.class);
                    startActivity(it);
                    break;
