...
public class ActiveMembersActivity extends CarPlayBaseActivity implements OnClickListener {
    ...
    public void initView() {
        ...
        String url = API.CWBaseurl + "/activity/" + activityId + "/members?userId=" + user.getUserId() + "&token="
                + user.getToken();
    ...
    private void quiteActive() {
        DhNet net = new DhNet(API.CWBaseurl + "/activity/" + activityId + "/quit?userId=" + user.getUserId()
                + "&token=" + user.getToken());
