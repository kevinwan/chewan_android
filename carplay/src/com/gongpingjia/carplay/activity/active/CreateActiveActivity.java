                ...
                public void doInUI(Response response, Integer transfer) {
                    ...
                    if (response.isSuccess()) {
                        ...
                        try {
                            ...
                            // 缩略图地址
                            final UMImage image = new UMImage(self, "http://cwapi.gongpingjia.com/v1/user/846de312-306c-4916-91c1-a5e69b158014/message/count?token=750dd49c-6129-4a9a-9558-27fa74fc4ce7");
