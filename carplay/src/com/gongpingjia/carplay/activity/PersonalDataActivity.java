 ...
 * 
 */
public class PersonalDataActivity extends CarPlayBaseActivity implements
		OnClickListener {
	RelativeLayout personal_city, personal_driving_years, personal_head,
			personal_nickname, personal_sex;
	ImageView head_img;
